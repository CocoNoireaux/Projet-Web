...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 03 mai 2019 à 15:14
...
(7, 'coco', 'coco@gmail.com', '123', 'France', 'Paris', '1235', 'fgieg', 'thSLQ8EJ4O.jpg', '127.0.0.1'),
(8, 'c', 'c@gmail.com', '1234', 'be', 'g', '1234', 'ihgerh', 'thSLQ8EJ4O.jpg', '127.0.0.1');
...
INSERT INTO `products` (`product_id`, `p_cat_id`, `cat_id`, `date`, `product_title`, `product_img1`, `product_img2`, `product_img3`, `product_video`, `product_price`, `product_keywords`, `product_desc`) VALUES
...
CREATE TABLE `vendeurs` (
  ...
  `vendeur_num` int(100) NOT NULL,
  `vendeur_adresse` varchar(255) NOT NULL,
  `vendeur_image` varchar(255) NOT NULL,
  `vendeur_ip` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `vendeurs`
  MODIFY `vendeur_id` int(100) NOT NULL AUTO_INCREMENT;
COMMIT;
