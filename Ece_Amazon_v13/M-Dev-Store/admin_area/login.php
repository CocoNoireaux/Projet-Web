...
<body>
   ...
   <div class="container"><!-- container begin -->
       <form action="" class="form-login" method="post"><!-- form-login begin -->
           ...
           <input type="text" class="form-control" placeholder="Adresse e-mail" name="admin_email" required>
...
<?php 
    ...
    if(isset($_POST['admin_login'])){
        ...
        if($count==1){
            ...
            echo "<script>alert('Vous êtes connecté. Bienvenue')</script>";
            
            echo "<script>window.open('index.php?dashboard','_self')</script>";
            
        }else{
            
            echo "<script>alert('Email ou mot de passe faux !')</script>";
