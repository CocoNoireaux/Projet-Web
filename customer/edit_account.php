...
<!-- formulaire pour editer son compte en tant qu'acheteur -->
<h1 align="center"> Editer votre compte </h1>

<form action="" method="post" enctype="multipart/form-data">
    <!-- saisi du nom et prenom-->
...
<?php 
//recuperation des informations saisies dans le formualire
if(isset($_POST['update'])){
    ...
    //alerte si le compte a bien été edité
    if($run_customer){
