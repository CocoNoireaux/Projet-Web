...
if(isset($_GET['pro_id'])){
    ...
    $get_product = "select * from products where product_id='$product_id'"; //requete sql table produit 
...
<body>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">
                   ...
                   <?php 
                   ///soit connecté en tant qu'invité soit avec son email
           ...
           <div class="col-md-6">
               <!-- lien vers les differentes icone du menu  -->
               <ul class="menu">
                   <li>
                   ...
                   <li>
                       <a href="../checkout.php">
                        ...
                        <?php 
                           ...
                           //lien avec la page se connecter ou se deconnecter
                           if(!isset($_SESSION['customer_email'])){
   ...
   <div id="navbar" class="navbar navbar-default">
       <div class="container">
           ...
           <!--lien avec les differentes pages-->
