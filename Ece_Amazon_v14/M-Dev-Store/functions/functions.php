...
function getpcatpro_vente_flash(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        $get_products ="select * from products where p_cat_id='$p_cat_id' order by nb_vente DESC";
...
function getcatpro_vente_flash(){
    ...
    if(isset($_GET['cat'])){
        ...
        $get_cat = "select * from products where cat_id='$cat_id' order by nb_vente DESC LIMIT 0,6";
