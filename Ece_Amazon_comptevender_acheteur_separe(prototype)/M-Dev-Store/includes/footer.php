    ...
    <div class="container"><!-- container Begin -->
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Pages</h4>
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="customer/my_account.php">Mon compte Acheteur</a></li>
                </ul><!-- ul Finish -->
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <form action="https://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=ECE_Amazon', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true" method="post"><!-- form begin -->
