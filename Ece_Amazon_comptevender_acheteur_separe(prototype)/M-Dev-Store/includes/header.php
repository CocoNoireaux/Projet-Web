           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">
                   ...
                   if(isset($_SESSION['customer_email'])){
                       ...
                       echo "Bienvenue: " . $_SESSION['vendeur_email'] . "";
                       
                   }if(!isset($_SESSION['vendeur_email']) && !isset($_SESSION['customer_email']) ){
               ...
               <a href="checkout.php"><?php items(); ?> Produits dans votre panier | Prix total: <?php total_price(); ?> </a>
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <li class="<?php if($active=='Account') echo"active"; ?>">
                           ...
                           if(!isset($_SESSION['customer_email'])){
                               ...
                               echo"<a href='checkout.php'>Acheteur</a>";
                               
                           }else{
                               
                              echo"<a href='customer/my_account.php?my_orders'>Acheteur</a>"; 
